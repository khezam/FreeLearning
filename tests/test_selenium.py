...
from app.blueprint_models import Role, User, Post
...
class SeleniumTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if cls.client:
            ...
            admin = User(email='john@example.com', username='john', password_hash=generate_password_hash('cat'), role=admin_role, confirmed=True)
